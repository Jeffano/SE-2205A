...
public class JeffanoDemoHashingWithLinearProbing {
    ...
    //Initializing the hashtables of JeffanoValueEntry type
    public static JeffanoValueEntry[] hashTable;
    public static JeffanoValueEntry[] workingHashTable;
    ...
    public static void rehashingWithLinearProbe(){
        ...
        workingHashTable = new JeffanoValueEntry[tableCapacity];

        //For loop to set the working hashtable with -1 values
        for(int i = 0; i < tableCapacity; i++){
            workingHashTable[i] = new JeffanoValueEntry();
        }

        //Sets the working hashtable with the values from teh hashtable
        for(int i = 0; i < tableCapacity; i++){
        ...
        hashTable = new JeffanoValueEntry[tableCapacity];

        //For loop to assign the hashtable with -1's
        for(int i = 0; i < tableCapacity; i++){
            hashTable[i] = new JeffanoValueEntry();
        }
